...
def GoogleSearch(term):
    ...
    oooooo = open('S:\\AI Jarvis\\How To Make Jarvis\\Data.txt','a')
    ...
    os.startfile('S:\\AI Jarvis\\How To Make Jarvis\\DataBase\\ExtraPro\\start.py')
...
def Alarm(query):
    ...
    TimeHere=  open('S:\\AI Jarvis\\How To Make Jarvis\\Data.txt','a')
    TimeHere.write(query)
    TimeHere.close()
    os.startfile("S:\\AI Jarvis\\How To Make Jarvis\\DataBase\\ExtraPro\\Alarm.py")
...
def DownloadYouTube():
    ...
    os.startfile('S:\\AI Jarvis\\How To Make Jarvis\\DataBase\\YouTube\\')

def SpeedTest():

    os.startfile("S:\\AI Jarvis\\How To Make Jarvis\\DataBase\\Gui Programs\\SpeedTestGui.py")
