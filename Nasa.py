...
def NasaNews(Date):
    ...
    Path_1 = "S:\\AI Jarvis\\How To Make Jarvis\\" + str(FileName)

    Path_2 = "S:\\AI Jarvis\\How To Make Jarvis\\DataBase\\NasaDataBase\\" + str(FileName)
...
def Summary(Boby):
    ...
    path = "S:\\AI Jarvis\\How To Make Jarvis\\DataBase\\NasaDataBase\\Images Used\\" + str(value) + ".jpg"
...
def MarsImage():
    ...
    try:
        ...
        for index , photo in enumerate(Photos):
            ...
            Path_1 = "S:\\AI Jarvis\\How To Make Jarvis\\" + str(img)

            Path_2 = "S:\\AI Jarvis\\How To Make Jarvis\\DataBase\\NasaDataBase\\MarsImage\\" + str(img)
